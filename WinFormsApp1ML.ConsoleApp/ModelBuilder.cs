...
namespace WinFormsApp1ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\72555\Desktop\Projects\Output_Data_For_Traning.csv";
        private static string MODEL_FILEPATH = @"C:\Users\72555\AppData\Local\Temp\MLVSTools\WinFormsApp1ML\WinFormsApp1ML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(new SdcaMaximumEntropyMulticlassTrainer.Options() { L2Regularization = 1E-05f, L1Regularization = 1f, ConvergenceTolerance = 0.1f, MaximumNumberOfIterations = 100, Shuffle = false, BiasLearningRate = 0.1f, LabelColumnName = "col10", FeatureColumnName = "Features" })
